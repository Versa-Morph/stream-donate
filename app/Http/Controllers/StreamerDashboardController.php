...
class StreamerDashboardController extends Controller
{
    ...
    public function updateSettings(Request $request): RedirectResponse
    {
        ...
        $streamer->update([
            ...
            'is_accepting_donation' => $request->has('is_accepting_donation') ? $request->boolean('is_accepting_donation') : $streamer->is_accepting_donation,
            'thank_you_message'     => $validated['thank_you_message'],
            'media_upload_enabled'  => $request->has('media_upload_enabled') ? $request->boolean('media_upload_enabled') : $streamer->media_upload_enabled,
