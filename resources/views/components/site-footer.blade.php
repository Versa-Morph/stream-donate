    ...
    <div class="footer-content">
        <div class="footer-main">
            ...
            <div class="footer-links">
                <a href="{{ route('home') }}#stats">Jejak Kami</a>
                <span class="footer-separator">•</span>
                <a href="{{ route('home') }}#features">Keunggulan</a>
                <span class="footer-separator">•</span>
                <a href="{{ route('home') }}#how-it-works">Panduan Awal</a>
                <span class="footer-separator">•</span>
                <a href="{{ route('home') }}#faq">Pusat Informasi</a>
                <span class="footer-separator">•</span>
